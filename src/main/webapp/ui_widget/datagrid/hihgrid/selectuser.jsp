...
<body>
	...
	<div class="easyui-layout" border="false" fit="true">
		...
		<form name="queryForm">
			<ul class="fieldSet">
				<li>员工姓名：<input name="filter_username" type="text" class="text"
					style="width: 100px;" />
				</li>
				<li>登陆帐号：<input name="filter_loginname" type="text"
					class="text" style="width: 100px;" />
				</li>
				<li>范围：<hih:parameter name="userState" id="userstate"
						type="checkbox" defValue="正常,调岗" />
				</li>
				<li class="west"><a class="easyui-linkbutton"
					iconCls="icon-search" id="btn-query">查询</a> <a
					class="easyui-linkbutton" iconCls="icon-reload" id="btn-reset">重置</a>
				</li>
			</ul>
		</form>
