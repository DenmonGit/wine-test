...
<%@ include file="/jf/common/taglibs.jsp"%>
<div class="datagrid-pager pagination" region="south" border="false"
	style="background: #EFEFEF;">
	<input type="hidden" name="pages" value="${pages}" /> <input
		type="hidden" name="orders" value="${orders}" />
	<table cellspacing="0" cellpadding="0" border="0">
		<tbody>
			<tr>
				...
				<td><div class="pagination-btn-separator"></div></td>
				<td><span style="padding-left: 6px;">当前第</span></td>
				<td><input class="pagination-num" name="page" value="${page}"
					type="text" size="2"></td>
